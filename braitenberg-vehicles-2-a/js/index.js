...
// Task 1:
// Create Braitenberg Vehicles of type 2.b 
// i.e. vehicles that are aggressively driving towards the light

// Task 2:
// Create your own environment
// i.e. using a brush, loading an image etc.

// Task 3:
// Make the braitenberg vehicles modify their environment

// Task 4:
// Take care of vehicles that reach the end of the table
// How can you make sure they stay inside the world?

// Task 5 (optional):
// Create Braitenberg Vehicles that experience love (type 3) or values and special tastes(type 4)
...
function createVehicle(x, y) {
  ...
  function sense() {
    ...
    leftSpeed = map(leftLight, 0, 255, 0, maxSpeed);
    rightSpeed = map(rightLight, 0, 255, 0, maxSpeed);
